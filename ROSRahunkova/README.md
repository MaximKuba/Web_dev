Під час всього семестру ми з командою розробляли проект для медичних центрів.Це сервіс,це сервіс,що дозволяє лікарями реєструвати та стажети за своїм пацієнтами.
